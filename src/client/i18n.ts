...
const dict = {
  ...
  costStackedHint: {
    en: "Click a bar to compare all models in that period",
    ja: "棒をクリックするとその期間の全モデルを比較できます",
  },
  detailPanelTitle: { en: "Model details", ja: "モデル詳細" },
  closeDetail: { en: "Close", ja: "閉じる" },
  detailNote: {
    en: "All models used in this period, sorted by effective unit price ($/MTok) descending. The ref badge marks models with fewer than {threshold} total tokens. Click rows to select up to 2 models.",
    ja: "この期間に利用実績のある全モデルを実効単価（$/MTok）の高い順に表示。ref は総トークン {threshold} 未満の参考値。行をクリックして最大 2 モデルを比較できます。",
  },
  tokenMix: { en: "Token mix", ja: "トークン構成" },
  refBadge: { en: "ref", ja: "参考値" },
  refBadgeTitle: { en: "Total tokens < {threshold}", ja: "総トークン {threshold} 未満" },
  selectModel: { en: "Select {model} for comparison", ja: "{model} を比較対象に選択" },
  compareSelectTwo: { en: "Click 2 models to compare them", ja: "モデルを 2 つ選ぶと比較できます" },
  compareSelectOneMore: { en: "Select one more model to compare", ja: "比較するモデルをもう 1 つ選択してください" },
  compareHead: { en: "Compare: {a} ↔ {b}", ja: "比較: {a} ↔ {b}" },
  compareSummary: {
    en: "unit price {unitPrice} · cost {cost} · tokens {tokens}",
    ja: "単価 {unitPrice} · コスト {cost} · トークン {tokens}",
  },
  compareNote: {
    en: "Effective unit price = cost ÷ total tokens × 1,000,000. Historical actuals only; does not measure model quality.",
    ja: "実効単価 = コスト ÷ 総トークン × 1,000,000。過去の実績のみに基づき、モデルの品質を評価するものではありません。",
  },
